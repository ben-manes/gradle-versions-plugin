 ...
 * plugin moved to `io.github.ben-manes.versions`. Releases are still published under the old id,
 * so that existing builds continue to be updated. Applying it logs a deprecation warning and
 * delegates to [VersionsPlugin].
 */
