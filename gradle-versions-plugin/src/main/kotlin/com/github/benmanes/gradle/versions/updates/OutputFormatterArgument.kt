...
sealed interface OutputFormatterArgument {
  /**
   * A string representing one of the built-in output formatters (i.e. "plain", "json", "xml", "html",
   * or "problems"), or a comma-separated list with a combination of them (e.g. "plain,json").
   */
